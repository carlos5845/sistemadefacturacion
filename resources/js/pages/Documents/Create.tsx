...
export default function DocumentsCreate({ customers = [], documentTypes = [], error: propError }: Props) {
    ...
    const handleSuccessClose = () => {
        ...
        // El documento redirige a su página de detalle, así que no necesitamos redirigir aquí
    };
                ...
                >
                    {({ processing, errors }) => (
                        <>
                            ...
                            <input type="hidden" name="total_taxed" value={totals.totalTaxed.toFixed(2)} />
                            <input type="hidden" name="total_igv" value={totals.totalIgv.toFixed(2)} />
                            <input type="hidden" name="total" value={totals.total.toFixed(2)} />
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="F001"
                                        required
                                        aria-invalid={errors.series ? 'true' : undefined}
                                    />
                            ...
                            <div className="space-y-4 rounded-lg border p-6">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-lg font-semibold">Items del Documento</h2>
                                ...
                                <div className="space-y-4">
                                    {items.map((item, index) => (
                                        <div key={index} className="grid gap-4 rounded-md border p-4 md:grid-cols-6">
                                            ...
                                            <input type="hidden" name={`items[${index}][total]`} value={item.total.toFixed(2)} />
                                            <input type="hidden" name={`items[${index}][igv]`} value={item.igv.toFixed(2)} />
